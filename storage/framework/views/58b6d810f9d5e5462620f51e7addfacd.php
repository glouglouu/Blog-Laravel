...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-8 text-center">
        ...
        <h2 class="text-2xl font-semibold text-gray-900">Vérifiez votre email</h2>
    ...
    <?php if(session('status') == 'verification-link-sent'): ?>
        <div class="mb-6 border border-green-200 rounded-lg bg-green-50 p-4">
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            <?php echo csrf_field(); ?>
            <button type="submit" class="w-full btn-minimal">
...
<?php endif; ?>
<?php /**PATH C:\Users\glouglou\Documents\Projets cours\php-laravel\blog-with-laravel\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>