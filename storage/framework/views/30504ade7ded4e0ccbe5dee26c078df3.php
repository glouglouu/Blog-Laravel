...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="bg-white font-sans antialiased">
        <div class="min-h-screen">
            ...
            <!-- Hero Section -->
            <div class="bg-gradient-to-b from-gray-100 via-gray-50 to-white border-b border-gray-200">
            ...
            <!-- Articles Section -->
            <div class="bg-pattern-warm py-16">
            ...
            <!-- Newsletter Section -->
            <div class="bg-gradient-to-b from-white via-gray-50 to-gray-100 border-t border-gray-200 py-16">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
...
<?php /**PATH C:\Users\glouglou\Documents\Projets cours\php-laravel\blog-with-laravel\resources\views/welcome.blade.php ENDPATH**/ ?>